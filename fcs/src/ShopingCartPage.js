...
import ShopingItemComponent from './ShopingItemComponent';
...
export default class ShopingCartPage extends Component {
    ...
    getMoney = (m) => {
        ...
        this.setState({ totalMoney : this.state.totalMoney })
        let i = 0;
    ...
    renderItem = (item) => {
        return (
            <ShopingItemComponent itemData={item} money={this.getMoney}/>
        )
    };
